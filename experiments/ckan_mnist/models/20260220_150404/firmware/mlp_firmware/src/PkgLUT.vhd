...
package PkgLUT is
  -- Layer 0
  constant LUT_SIZE_0        : integer := 65536;
  constant LUT_ADDR_WIDTH_0  : integer := 16;
  constant LUT_DATA_WIDTH_0  : integer := 16;
  ...
  -- Layer 1
  constant LUT_SIZE_1        : integer := 65536;
  constant LUT_ADDR_WIDTH_1  : integer := 16;
  constant LUT_DATA_WIDTH_1  : integer := 16;
