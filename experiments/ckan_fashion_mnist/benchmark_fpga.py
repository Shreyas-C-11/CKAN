...
#   python benchmark_fpga.py --bitstream ckan_fashion_mnist.bit --num_images 1000
#
# Measures:
...
def print_results(latencies, all_times, correct, num_images, num_runs):
    ...
    print()
    print("=" * 65)
    print("  CKAN FPGA Inference Benchmark — Fashion-MNIST — PYNQ-Z2")
    print("=" * 65)
...
def main():
    parser = argparse.ArgumentParser(description="CKAN FPGA Inference Benchmark")
    parser.add_argument("--bitstream", type=str, required=True,
                        help="Path to .bit file (e.g., ckan_mnist.bit)")
