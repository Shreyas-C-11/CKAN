# prepare_fpga_data.py — Convert Fashion-MNIST images to FPGA-ready hex files
#
# Generates:
...
def main():
    parser = argparse.ArgumentParser(description="Prepare Fashion-MNIST data for FPGA inference")
    ...
    print(f"Exporting {num_images} Fashion-MNIST test images to {args.output_dir}/")
    ...
    with open(combined_path, 'w') as f:
        for idx in range(num_images):
            ...
            raw_pixels = (image[0] * 0.3530 + 0.2860) * 255.0
            raw_pixels = raw_pixels.clamp(0, 255).to(torch.uint8)
